...
<body>
  ...
  <div class="modal" data-modal>
    ...
    <div class="modal-content">
      ...
      <div class="newsletter-img">
        <img src="./assets/images/somali/somali(3).jpg" alt="subscribe newsletter" width="400" height="400">
      </div>
        ...
        <form action="#">
          ...
          <div class="newsletter-header">
            ...
            <p class="newsletter-desc">
              Subscribe to <b>Eastleigh</b> to get latest products and discount update.
            </p>
    ...
    <div class="header-top">
      ...
      <div class="container">
        ...
        <ul class="header-social-container">
          ...
          <li>
            <a href="https://www.facebook.com/Eastleighio/" class="social-link">
              <ion-icon name="logo-facebook"></ion-icon>
            </a>
          </li>

          <li>
            <a href="https://twitter.com/EastleighIo?t=hMLuE4F7PclMl8X-_XJllA&s=09" class="social-link">
        ...
        <div class="header-alert-news">
          <p>
            <b>Free Shipping</b>
            This Week Order Over - ksh 5500.00
          </p>
        </div>
    ...
    <div class="header-main">
      ...
      <div class="container">
        ...
        <a href="#" class="header-logo">
          <img src="./assets/images/logo/BBBBB-removebg.png" alt="logo" width="150">
        </a>
        ...
        <div class="header-user-actions">
          ...
          <button class="action-btn dropdown">
            <ion-icon name="person-outline" class="dropbtn" class=""></ion-icon>  
  ...
  <main>
      ...
      <div class="container">
        ...
        <div class="slider-container has-scrollbar">
          ...
          <div class="slider-item">
            ...
            <img src="./assets/images/somali/somali(8).jpg" alt="women's latest fashion sale" class="banner-img">

            <div class="banner-content" style="background: white;">
          ...
          <div class="slider-item">
            ...
            <img src="./assets/images/somali/somali(7).jpg" alt="modern sunglasses" class="banner-img">
          ...
          <div class="slider-item">
            ...
            <img src="./assets/images/somali/somali(11).jpg" alt="new fashion summer sale" class="banner-img">
            ...
            <div class="product-grid">
              ...
              <div class="showcase">
                ...
                <div class="showcase-content">
                  ...
                  <a href="product.html" class="showcase-category">jacket</a>
              ...
              <div class="showcase">
                ...
                <div class="showcase-content">
                  <a href="product.html" class="showcase-category">shirt</a>
              ...
              <div class="showcase">
                ...
                <div class="showcase-content">
                  <a href="product.html" class="showcase-category">skirt</a>
                ...
                <div class="showcase">
                  ...
                  <div class="showcase-content">
                    ...
                    <h3 class="showcase-title">
                      <a href="product.html" class="showcase-title">Rose Gold diamonds Earring</a>
                    </h3>
    ...
    <div class="blog">
      ...
      <div class="container">
        <h2 class="title">OUR TRADE SERVICES</h2>
        ...
        <div class="blog-container has-scrollbar">
          ...
          <div class="blog-card">
            ...
            <div class="blog-content">
              ...
              <a href="#" class="blog-category">TRADE ASSUARANCE</a>

              <a href="#">
                <h3 class="blog-title">ORDER PROTECTION</h3>
              </a>
          ...
          <div class="blog-card">
            ...
            <div class="blog-content">
              ...
              <a href="#" class="blog-category">PAYMENT</a>
          
              <h3>
                <a href="#" class="blog-title">PAYMENT SOLUTION.</a>
              </h3>
          ...
          <div class="blog-card">
            ...
            <div class="blog-content">
              ...
              <a href="#" class="blog-category">INSPECTION</a>
          
              <h3>
                <a href="#" class="blog-title">INSPECTION SOLUTION</a>
              </h3>
          ...
          <div class="blog-card">
            ...
            <div class="blog-content">
              ...
              <a href="#" class="blog-category">OCEAN AND AIR SHIPPING</a>
          
              <h3>
                <a href="#" class="blog-title">LOGISTICS SOLUTIONS</a>
              </h3>
  ...
  <footer>
      ...
      <div class="container">
        ...
        <ul class="footer-nav-list">
          ...
          <li class="footer-nav-item flex">
            ...
            <a href="tel:+607936-8058" class="footer-nav-link">(254) 794-752-122</a>
          </li>
          ...
          <li class="footer-nav-item flex">
            ...
            <a href="mailto:eastleigh.ioi@gmail.com" class="footer-nav-link">eastleigh.ioi@gmail.com</a>
          </li>
        ...
        <ul class="footer-nav-list">
          ...
          <li>
            <ul class="social-link">
              ...
              <li class="footer-nav-item">
                <a href="https://www.facebook.com/Eastleighio/" class="footer-nav-link">
                  <ion-icon name="logo-facebook"></ion-icon>
                </a>
              </li>

              <li class="footer-nav-item">
                <a href="https://twitter.com/EastleighIo?t=hMLuE4F7PclMl8X-_XJllA&s=09" class="footer-nav-link">
                  <ion-icon name="logo-twitter"></ion-icon>
                </a>
              </li>
    ...
    <div class="footer-bottom">
      ...
      <div class="container">
        ...
        <p class="copyright">
          Copyright &copy; <a href="#">Eastleigh.io</a> all rights reserved.
        </p>
